...
signal_cache_root=${SIGNAL_CACHE_ROOT:-/your/path/to/vlac_cache_root}
...
base_vlm=${BASE_VLM:-/your/path/to/base_vlm}
...
libero_data_root=${LIBERO_DATA_ROOT:-/your/path/to/libero_lerobot}
data_mix=${DATA_MIX:-libero_goal}
run_root_dir=${RUN_ROOT_DIR:-/your/path/to/train_run_root}

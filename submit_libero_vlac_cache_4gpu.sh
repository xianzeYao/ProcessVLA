#!/bin/bash
#SBATCH --job-name=qwen3vl_libero_vlac
...
#SBATCH --mem=512G
#SBATCH --output=/home/n84416302/ProcessVLA/slurm_%j.out
#SBATCH --error=/home/n84416302/ProcessVLA/slurm_%j.err
...
accelerate launch \
  ...
  --run_id qwen3vl_gr00t_libero_goal_4gpu_$(date +%Y%m%d_%H%M%S) \
  ...
  --signal.cache_root /home/n84416302/ProcessVLA/vlac_cache_libero_goal \

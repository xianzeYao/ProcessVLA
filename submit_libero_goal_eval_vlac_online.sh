#!/bin/bash
#SBATCH --job-name=qwen3vl_goal_eval_vlac
...
#SBATCH --mem=256G
#SBATCH --output=/home/n84416302/ProcessVLA/slurm/slurm_eval_goal_%j.out
#SBATCH --error=/home/n84416302/ProcessVLA/slurm/slurm_eval_goal_%j.err

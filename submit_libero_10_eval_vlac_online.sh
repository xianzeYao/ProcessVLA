#!/bin/bash
#SBATCH --job-name=qwen3vl_libero10_eval_vlac
...
#SBATCH --mem=256G
#SBATCH --output=/home/n84416302/ProcessVLA/slurm/slurm_eval_libero10_%j.out
#SBATCH --error=/home/n84416302/ProcessVLA/slurm/slurm_eval_libero10_%j.err
...
export VLAC_REFERENCE_DATASET_NAME=libero_10_no_noops_1.0.0_lerobot
export VLAC_REFERENCE_SEED=10
export VLAC_REFERENCE_DATA_ROOT_DIR=/home/n84416302/dataset/LEROBOT_LIBERO_DATA
export VLAC_REFERENCE_DATA_MIX=libero_10

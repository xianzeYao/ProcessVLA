"""VLA trainer entry point for QwenGR00TCoTV3."""
...
class CotV3Trainer(CotV2Trainer):
    """Reuse the CoT lifecycle with the independent V3 framework."""


def main(cfg) -> None:
    logger.info("QwenGR00TCoT V3 training :: Warming Up")
    cfg = wrap_config(cfg)
